<template>
    <div class="home-container">
        <div class="slogan">
            <div class="magictime vanishIn"><img src="@/assets/images/slogan.webp" id="slogan" alt=""></div>
            <div class="magictime slideRightReturn"><img src="@/assets/images/people-1.webp" id="people" alt=""></div>
