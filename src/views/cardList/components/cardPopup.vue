<template>
  ...
  >
    <el-descriptions :column="3" direction="vertical">
      <el-descriptions-item label="卡牌类型" align="left"
        >{{ curCard.type || "--" }}
      </el-descriptions-item>
      <el-descriptions-item label="从属包" align="left"
        >{{ curCard.pack || "--" }}
      </el-descriptions-item>
      <el-descriptions-item label="作者" align="left"
        >{{ curCard.author || "--" }}
      </el-descriptions-item>
    </el-descriptions>
    <el-descriptions :column="curCard.back ? 1 : 2" direction="vertical">
      <el-descriptions-item label="卡牌名称" align="left"
        >{{ curCard.front || "--" }}
      </el-descriptions-item>

      <el-descriptions-item label="卡牌描述" align="left"
        >{{ curCard.back || "--" }}
      </el-descriptions-item>
    </el-descriptions>
    <template #footer>
